...
public class StreamMap {
    ...
    public static Stream<String> letters(String someWord) {
        ...
        return Stream.of(someWord.toCharArray()).map(Objects::toString);
    }
    ...
    public static Stream<Stream<String>> wordsMap(String... someWords) {
        ...
        return Stream.of(someWords).map(s -> Stream.of(s.toCharArray()).map(Objects::toString));
    }
    ...
    public static Stream<String> wordsFlatMap(String... stringArray) {
        return Arrays.stream(stringArray).flatMap(words -> letters(words));
    }
}